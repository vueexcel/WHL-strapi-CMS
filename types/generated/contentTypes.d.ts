...
export interface ApiCaseStudyCaseStudy extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.Component<'case-study-section.sections', true>;
...
export interface ApiCompanyLogoCompanyLogo extends Struct.CollectionTypeSchema {
...
export interface ApiContactsContacts extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locationPage: Schema.Attribute.String;
